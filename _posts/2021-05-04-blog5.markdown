...
Using the tonal vocabulary and appropriate calculations we can develop an application to detect whether a given message is a spam or not.<br>
Following is a simple Graphical User Interface that can be found in the git project.
<br><br>
